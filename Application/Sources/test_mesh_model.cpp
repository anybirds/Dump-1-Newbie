...
int test_mesh_model(int argc, char **argv) {
	...
	Mesh bunny_mesh("Resources\\Meshes\\bunny_mesh.obj");

#ifdef DEBUG
	cout << '[' << __FUNCTION__ << ']' << " mesh creation done ..." << endl;
#endif

	string vert_path = "Resources\\Shaders\\test_mesh_model_vertexshader.glsl";
	string frag_path = "Resources\\Shaders\\test_mesh_model_fragmentshader.glsl";
