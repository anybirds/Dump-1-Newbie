...
static Texture::Texture() {
	m_textures = gcnew System::Collections::Generic::Dictionary<System::String^, Texture^>();
}
...
Texture::Texture(String ^name, String ^path) 
	: ManagedObject<Core::Texture>(new Core::Texture(Utility::StringToCharArray(path))), m_name(name) {
